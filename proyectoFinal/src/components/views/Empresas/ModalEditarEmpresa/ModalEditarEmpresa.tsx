...
export const ModalEditarEmpresa: FC<IProsEditarEmpresa> = ({
  empresa,
  visible,
  onClose,
}) => {
        ...
        <div className={styleModalEditar.popUpContainer}>
          <div className={styleModalEditar.contenido}>
            ...
            >
              ...
              />
              {/* CUIL */}
              <div className={styleModalEditar.cuitContainer}>
              ...
              <div className={styleModalEditar.containerButtonsForm}>
                <Button
                  variant="primary"
                  onClick={cancelForm}
                  className={styleModalEditar.formButtonCancel}
                >
                  Cerrar
                </Button>
                <Button
                  ...
                  type="submit"
                  onClick={addForm}
                  className={styleModalEditar.formButtonSend}
                >
                  Enviar
                </Button>
              </div>
